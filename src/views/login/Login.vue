<template>
  ...
  >
    ...
    <el-form-item label="用户名" label-width="80px" prop="username" class="username">
      <el-input type="input" v-model="form.username" auto-complete="off" placeholder="请输入账号">
      </el-input>
    </el-form-item>
    <el-form-item label="密码" label-width="80px" prop="password">
      <!-- keyup.enter.native是进行键盘回车键的监听，输完密码按回车登录 -->
      <el-input
        type="password"
    ...
    return {
      ...
      rules: {
        username: [
          ...
          { min: 3, message: '用户名长度小于3位', trigger: 'blur' },
        ],
